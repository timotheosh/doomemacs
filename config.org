...
(use-package! gambit)
(use-package! treadmill)
(add-hook! 'inferior-scheme-mode-hook #'gambit-inferior-mode)
(defvar gerbil-home
  (string-trim (shell-command-to-string (format "dirname $(dirname %s)" (string-trim (shell-command-to-string "which gxi"))))))
(defvar gerbil-program-name (string-trim (shell-command-to-string "which gxi")))
