...
(map! :map exercism-mode-map
      :leader
      (:prefix ("x" . "exercism")
       :desc "Exercism: Submit current file"      "s" #'exercism-submit-file
       :desc "Exercism: Download a new exercise"  "d" #'exercism-download-exercise
       :desc "Exercism: Paste a download command" "p" #'exercism-download-command
       :desc "Exercism: Refresh current exercise" "r" #'exercism-refresh-exercise))
(map! :map ranger-mode-map
      :leader
      (:prefix ("x" . "exercism")
       :desc "Exercism: Submit marked files"      "x" #'exercism-dired-submit-marked-files))
#+end_src
** Clojure
#+BEGIN_SRC emacs-lisp
...
(after! python
  (when (executable-find "ipython")
    ...
    (setq! python-shell-interpreter-args "-i --no-ignore-cwd --no-banner")))
#+end_src
