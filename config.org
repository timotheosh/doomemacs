...
**** package
#+begin_src emacs-lisp :tangle packages.el
(package! org-transclusions :recipe (:host github :repo "nobiot/org-transclusion")
  :pin "b10d4de") ;; Commit date Aug 19, 2023
#+end_src
**** config
#+begin_src emacs-lisp
...
(setq! org-publish-project-alist
       '(("naurrnen-website"
          ...
          :creator (concat "GNU Emacs: " emacs-version "  Org-mode: " (org-version) " Tim Hawes © 2023")
       ...
       (setq!  org-html-validation-link nil
               org-html-head-include-script nil
