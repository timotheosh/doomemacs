...
(map! :map smartparens-mode-map
      (:g "C-M-a" #'sp-beginning-of-sexp
       ...
       :g "C-c :g "  #'wrap-with-parens
       :g "C-c ["  #'wrap-with-brackets
       :g "C-c {"  #'wrap-with-braces
       :g "C-c '"  #'wrap-with-single-quotes
       :g "C-c \"" #'wrap-with-double-quotes
       :g "C-c _"  #'wrap-with-underscores
       :g "C-c `"  #'wrap-with-back-quotes))
#+end_src
